...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","ARAME9")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","ASLIF903")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","OLDODISHA")
...
async def ping(client, message: Message):
        ...
        await message.reply_photo(
                             photo=START_IMG,
                             caption=f"ʜᴇʏ ʙᴀʙʏ!!\n**[{BOT_NAME}](t.me/ASXQUEEN)** ɪꜱ ᴀʟɪᴠᴇ 🥀 ᴀɴᴅ ᴡᴏʀᴋɪɴɢ ꜰɪɴᴇ ᴡɪᴛʜ ᴘᴏɴɢ ᴏꜰ \n➥ `{ms}` ms\n\n**ᴍᴀᴅᴇ ᴡɪᴛʜ ❣️ ʙʏ || [ᴘᴀɢᴀʟ](https://t.me/MR_NAVEEN720)||**",
